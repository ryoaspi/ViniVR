...
Shader "Vefects/SH_Vefects_URP_VFX_Bubbles_Particles_Transparent"
{
	Properties
	{
	...
	LOD 0
		...
		Pass
		{
			...
			float _FrCenterBias;
			float _FrCenterScale;
			float _FrCenterPower;
			float _SpeCular;
			float _OpacityFrBias;
			float _Smoothness;
			float _HueShift;
			float _FrEmissionMultiply;
			float _OpacityMin;
			float _CenterActive;
			...
			PackedVaryings VertexFunction( Attributes input  )
			{
				...
				#endif
				float Tile_Rand219 = input.texcoord1.x;
				float overallTilesMult159 = ( _OverallTilesMultiply * Tile_Rand219 );
				float3 temp_output_118_0 = ( ( ( staticSwitch192 * ( _WPOTile * overallTilesMult159 ) ) + _WPOTileOffsetCustom ) + ( _TimeParameters.x * _WPOTileSpeed ) );
				...
				float WPO_Rand212 = input.texcoord.z;
				float4 lerpResult100 = lerp( float4( float3( 0, 0, 0 ) , 0.0 ) , ( float4( input.normalOS , 0.0 ) * saturate( ( ( tex2Dlod( _WPOTriplanarTexture, float4( (temp_output_118_0).xy, 0, 0.0) ) * break127.z ) + ( tex2Dlod( _WPOTriplanarTexture, float4( (temp_output_118_0).yz, 0, 0.0) ) * break127.x ) + ( tex2Dlod( _WPOTriplanarTexture, float4( (temp_output_118_0).xz, 0, 0.0) ) * break127.y ) ) ) ) , ( _WPOIntensity * WPO_Rand212 ));
						 ...
						 ) : SV_Target
			{
				...
				float HueShift249 = ( _HueShift + ( _TimeParameters.x * _HueShiftSpeed ) );
				float3 hsvTorgb88 = HSVToRGB( float3(( hsvTorgb89.x + HueShift249 ),hsvTorgb89.y,hsvTorgb89.z) );
				float fresnelNdotV242 = dot( NormalWS, ViewDirWS );
				...
				float3 lerpResult237 = lerp( ( (input.ase_color).rgb * _CenterColor.rgb ) , hsvTorgb88 , CenFr247);
				...
				float fresnelNdotV170 = dot( NormalWS, ViewDirWS );
				...
				float3 BaseColor = BC197;
				float3 Normal = float3(0, 0, 1);
				float3 Specular = temp_cast_4;
				float Metallic = 0;
				float Smoothness = _Smoothness;
				float Occlusion = 1;
				float3 Emission = EM195.rgb;
				float Alpha = op179;
		...
		Pass
		{
			...
			PackedVaryings VertexFunction( Attributes input )
			{
				...
				float3 staticSwitch192 = ( ase_positionWS - objToWorld112 );
				#endif
				float Tile_Rand219 = input.ase_texcoord1.x;
				float overallTilesMult159 = ( _OverallTilesMultiply * Tile_Rand219 );
				float3 temp_output_118_0 = ( ( ( staticSwitch192 * ( _WPOTile * overallTilesMult159 ) ) + _WPOTileOffsetCustom ) + ( _TimeParameters.x * _WPOTileSpeed ) );
				float3 ase_normalWS = TransformObjectToWorldNormal( input.normalOS );
				float3 temp_cast_2 = (_WPOTriplanarContrast).xxx;
				...
				float3 break129 = temp_output_125_0;
				float3 break127 = ( temp_output_125_0 / ( break129.x + break129.y + break129.z ) );
				float WPO_Rand212 = input.ase_texcoord.z;
				float4 lerpResult100 = lerp( float4( float3( 0, 0, 0 ) , 0.0 ) , ( float4( input.normalOS , 0.0 ) * saturate( ( ( tex2Dlod( _WPOTriplanarTexture, float4( (temp_output_118_0).xy, 0, 0.0) ) * break127.z ) + ( tex2Dlod( _WPOTriplanarTexture, float4( (temp_output_118_0).yz, 0, 0.0) ) * break127.x ) + ( tex2Dlod( _WPOTriplanarTexture, float4( (temp_output_118_0).xz, 0, 0.0) ) * break127.y ) ) ) ) , ( _WPOIntensity * WPO_Rand212 ));
				float4 VO193 = lerpResult100;
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_Target
			{
				...
				float fresnelNode202 = ( _FrBias + _FrScale * pow( max( 1.0 - fresnelNdotV202 , 0.0001 ), _FrPower ) );
				float CFr227 = saturate( fresnelNode202 );
				float LUT_Rand214 = input.ase_texcoord4.w;
				float2 temp_cast_1 = (( ( CFr227 + ( _LUTOffset + LUT_Rand214 ) ) * _LUTAmplitude )).xx;
				float2 panner208 = ( 1.0 * _Time.y * temp_cast_0 + temp_cast_1);
				float3 desaturateInitialColor187 = tex2D( _LUT, panner208 ).rgb;
				float desaturateDot187 = dot( desaturateInitialColor187, float3( 0.299, 0.587, 0.114 ));
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_Target
			{
				...
				float fresnelNode202 = ( _FrBias + _FrScale * pow( max( 1.0 - fresnelNdotV202 , 0.0001 ), _FrPower ) );
				float CFr227 = saturate( fresnelNode202 );
				float LUT_Rand214 = input.ase_texcoord2.w;
				float2 temp_cast_1 = (( ( CFr227 + ( _LUTOffset + LUT_Rand214 ) ) * _LUTAmplitude )).xx;
				float2 panner208 = ( 1.0 * _Time.y * temp_cast_0 + temp_cast_1);
				float3 desaturateInitialColor187 = tex2D( _LUT, panner208 ).rgb;
				float desaturateDot187 = dot( desaturateInitialColor187, float3( 0.299, 0.587, 0.114 ));
		...
		Pass
		{
						 ...
						 )
			{
				...
				float3 ase_viewVectorWS = ( ( unity_OrthoParams.w == 0 ) ? _WorldSpaceCameraPos - PositionWS : UNITY_MATRIX_V[ 2 ].xyz );
				float3 ase_viewDirWS = normalize( ase_viewVectorWS );
				float fresnelNdotV170 = dot( NormalWS, ase_viewDirWS );
				float fresnelNode170 = ( _OpacityFrBias + _OpacityFrScale * pow( max( 1.0 - fresnelNdotV170 , 0.0001 ), _OpacityFrPower ) );
				float lerpResult171 = lerp( _OpacityMin , _OpacityMax , fresnelNode170);
				float op179 = saturate( ( saturate( lerpResult171 ) * _OpacityOverall ) );
...
{"type":"AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor","id":158,"pos":[-1712,-2480],"params":["Inherit","False","Property","_OverallTilesMultiply","Overall Tiles Multiply","3","0","Create","True","0","0","0","False","0","False","Object","-1","","1","1","0","0","0","1","FLOAT","0"]}
...
{"type":"AmplifyShaderEditor.Vector3Node, AmplifyShaderEditor","id":122,"pos":[-8064,1664],"params":["Inherit","False","Property","_WPOTile","WPO Tile","27","0","Create","True","0","0","0","False","0","False","Object","-1","","1,1,1","1,1,1","0","4","FLOAT3","0","FLOAT","1","FLOAT","2","FLOAT","3"]}
...
{"type":"AmplifyShaderEditor.StaticSwitch, AmplifyShaderEditor","id":192,"pos":[-7808,1024],"params":["Inherit","False","Property","_UseWorldSpace","Use World Space","4","0","Create","True","0","0","0","False","0","False","","0","0","0","True","","Toggle","2","Key0","Key1","Create","True","True","All","9","1","FLOAT3","0,0,0","False","0","FLOAT3","0,0,0","False","2","FLOAT3","0,0,0","False","3","FLOAT3","0,0,0","False","4","FLOAT3","0,0,0","False","5","FLOAT3","0,0,0","False","6","FLOAT3","0,0,0","False","7","FLOAT3","0,0,0","False","8","FLOAT3","0,0,0","False","1","FLOAT3","0"]}
...
{"type":"AmplifyShaderEditor.Vector3Node, AmplifyShaderEditor","id":121,"pos":[-7040,1408],"params":["Inherit","False","Property","_WPOTileSpeed","WPO Tile Speed","28","0","Create","True","0","0","0","False","0","False","Object","-1","","0,1,1","1,1,1","0","4","FLOAT3","0","FLOAT","1","FLOAT","2","FLOAT","3"]}
{"type":"AmplifyShaderEditor.Vector3Node, AmplifyShaderEditor","id":138,"pos":[-7552,1664],"params":["Inherit","False","Property","_WPOTileOffsetCustom","WPO Tile Offset Custom","29","0","Create","True","0","0","0","False","0","False","Object","-1","","0,0,0","0,0,0","0","4","FLOAT3","0","FLOAT","1","FLOAT","2","FLOAT","3"]}
...
{"type":"AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor","id":124,"pos":[-5504,1024],"params":["Inherit","False","Property","_WPOTriplanarContrast","WPO Triplanar Contrast","26","0","Create","True","0","0","0","False","0","False","Object","-1","","1","1","0","0","0","1","FLOAT","0"]}
...
{"type":"AmplifyShaderEditor.TexturePropertyNode, AmplifyShaderEditor","id":110,"pos":[-6528,896],"params":["Inherit","True","Property","_WPOTriplanarTexture","WPO Triplanar Texture","24","0","Create","True","0","0","0","False","3","Space(33)","Header(WPO Triplanar)","Space(13)","False","","edba5d18294de3a4daddbf6d71ac0849","edba5d18294de3a4daddbf6d71ac0849","False","white","Auto","Texture2D","False","-1","0","2","SAMPLER2D","0","SAMPLERSTATE","1"]}
{"type":"AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor","id":169,"pos":[-2560,2432],"params":["Inherit","False","Property","_OpacityFrBias","Opacity Fr Bias","35","0","Create","True","0","0","0","False","0","False","Object","-1","","0","0","0","0","0","1","FLOAT","0"]}
{"type":"AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor","id":167,"pos":[-2560,2688],"params":["Inherit","False","Property","_OpacityFrPower","Opacity Fr Power","34","0","Create","True","0","0","0","False","0","False","Object","-1","","1","1","0","0","0","1","FLOAT","0"]}
{"type":"AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor","id":168,"pos":[-2560,2560],"params":["Inherit","False","Property","_OpacityFrScale","Opacity Fr Scale","33","0","Create","True","0","0","0","False","0","False","Object","-1","","1","1","0","0","0","1","FLOAT","0"]}
...
{"type":"AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor","id":172,"pos":[-2176,2176],"params":["Inherit","False","Property","_OpacityMin","Opacity Min","31","0","Create","True","0","0","0","False","0","False","Object","-1","","0","0","0","0","0","1","FLOAT","0"]}
{"type":"AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor","id":173,"pos":[-2176,2304],"params":["Inherit","False","Property","_OpacityMax","Opacity Max","32","0","Create","True","0","0","0","False","0","False","Object","-1","","1","1","0","0","0","1","FLOAT","0"]}
...
{"type":"AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor","id":177,"pos":[-1280,2304],"params":["Inherit","False","Property","_OpacityOverall","Opacity Overall","30","0","Create","True","0","0","0","False","3","Space(33)","Header(Opacity)","Space(13)","False","Object","-1","","1","1","0","0","0","1","FLOAT","0"]}
...
{"type":"AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor","id":102,"pos":[-1792,1536],"params":["Inherit","False","Property","_WPOIntensity","WPO Intensity","25","0","Create","True","0","0","0","False","0","False","Object","-1","","0.1","0","0","0","0","1","FLOAT","0"]}
...
{"type":"AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor","id":182,"pos":[736,32],"params":["Inherit","False","Property","_Src","Src","37","0","Create","True","0","0","0","True","0","False","Object","-1","","5","5","0","0","0","1","FLOAT","0"]}
{"type":"AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor","id":183,"pos":[992,32],"params":["Inherit","False","Property","_Dst","Dst","38","0","Create","True","0","0","0","True","0","False","Object","-1","","10","10","0","0","0","1","FLOAT","0"]}
{"type":"AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor","id":184,"pos":[1248,32],"params":["Inherit","False","Property","_ZWrite","ZWrite","39","0","Create","True","0","0","0","True","0","False","Object","-1","","0","0","0","0","0","1","FLOAT","0"]}
{"type":"AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor","id":185,"pos":[1504,32],"params":["Inherit","False","Property","_ZTest","ZTest","40","0","Create","True","0","0","0","True","0","False","Object","-1","","2","2","0","0","0","1","FLOAT","0"]}
{"type":"AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor","id":181,"pos":[480,32],"params":["Inherit","False","Property","_Cull","Cull","36","0","Create","True","0","0","0","True","3","Space(33)","Header(AR)","Space(13)","False","Object","-1","","2","2","0","0","0","1","FLOAT","0"]}
...
{"type":"AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor","id":12,"pos":[-640,256],"params":["Inherit","False","Property","_Smoothness","Smoothness","2","0","Create","True","0","0","0","False","0","False","Object","-1","","0.99","0.99","0","0","0","1","FLOAT","0"]}
{"type":"AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor","id":11,"pos":[-640,128],"params":["Inherit","False","Property","_SpeCular","SpeCular","1","0","Create","True","0","0","0","False","0","False","Object","-1","","0.01","0.01","0","0","0","1","FLOAT","0"]}
...
{"type":"AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor","id":188,"pos":[-3840,-768],"params":["Inherit","False","Property","_LUTDesaturate","LUT Desaturate","9","0","Create","True","0","0","0","False","0","False","Object","-1","","0","0","0","0","0","1","FLOAT","0"]}
...
{"type":"AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor","id":207,"pos":[-4864,-768],"params":["Inherit","False","Property","_LUTAmplitude","LUT Amplitude","7","0","Create","True","0","0","0","False","0","False","Object","-1","","1","1","0","0","0","1","FLOAT","0"]}
...
{"type":"AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor","id":205,"pos":[-5632,-768],"params":["Inherit","False","Property","_LUTOffset","LUT Offset","6","0","Create","True","0","0","0","False","0","False","Object","-1","","0","0","0","0","0","1","FLOAT","0"]}
...
{"type":"AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor","id":77,"pos":[-5632,-256],"params":["Inherit","False","Property","_FrPower","Fr Power","21","0","Create","True","0","0","0","False","0","False","Object","-1","","1","1","0","0","0","1","FLOAT","0"]}
{"type":"AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor","id":76,"pos":[-5632,-384],"params":["Inherit","False","Property","_FrScale","Fr Scale","20","0","Create","True","0","0","0","False","0","False","Object","-1","","1","1","0","0","0","1","FLOAT","0"]}
{"type":"AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor","id":78,"pos":[-5632,-512],"params":["Inherit","False","Property","_FrBias","Fr Bias","22","0","Create","True","0","0","0","False","0","False","Object","-1","","0","0","0","0","0","1","FLOAT","0"]}
{"type":"AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor","id":245,"pos":[-5632,0],"params":["Inherit","False","Property","_FrCenterScale","Fr Center Scale","15","0","Create","True","0","0","0","False","0","False","Object","-1","","1","1","0","0","0","1","FLOAT","0"]}
{"type":"AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor","id":244,"pos":[-5632,128],"params":["Inherit","False","Property","_FrCenterPower","Fr Center Power","16","0","Create","True","0","0","0","False","0","False","Object","-1","","1","1","0","0","0","1","FLOAT","0"]}
{"type":"AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor","id":246,"pos":[-5632,-128],"params":["Inherit","False","Property","_FrCenterBias","Fr Center Bias","17","0","Create","True","0","0","0","False","0","False","Object","-1","","0","0","0","0","0","1","FLOAT","0"]}
...
{"type":"AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor","id":80,"pos":[-2304,384],"params":["Inherit","False","Property","_EmissionMultiply","Emission Multiply","0","0","Create","True","0","0","0","False","3","Space(13)","Header(General)","Space(13)","False","Object","-1","","0","0","0","0","0","1","FLOAT","0"]}
...
{"type":"AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor","id":232,"pos":[-3072,256],"params":["Inherit","False","Property","_FrEmissionMultiply","Fr Emission Multiply","23","0","Create","True","0","0","0","False","0","False","Object","-1","","0","0","0","0","0","1","FLOAT","0"]}
...
{"type":"AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor","id":99,"pos":[-1536,-2816],"params":["Inherit","False","Property","_HueShiftSpeed","Hue Shift Speed","12","0","Create","True","0","0","0","False","0","False","Object","-1","","0","0","0","0","0","1","FLOAT","0"]}
{"type":"AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor","id":94,"pos":[-1536,-3072],"params":["Inherit","False","Property","_HueShift","Hue Shift","11","0","Create","True","0","0","0","False","0","False","Object","-1","","0","0","0","0","0","1","FLOAT","0"]}
...
{"type":"AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor","id":240,"pos":[-3840,-2048],"params":["Inherit","False","Property","_CenterActive","Center Active","14","0","Create","True","0","0","0","False","0","False","Object","-1","","0","1","0","1","0","1","FLOAT","0"]}
...
{"type":"AmplifyShaderEditor.ColorNode, AmplifyShaderEditor","id":190,"pos":[-3584,-768],"params":["Inherit","False","Property","_LUTTint","LUT Tint","10","0","Create","True","0","0","0","False","0","False","Object","-1","","1,1,1,0","1,1,1,0","True","True","0","6","COLOR","0","FLOAT","1","FLOAT","2","FLOAT","3","FLOAT","4","FLOAT3","5"]}
...
{"type":"AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor","id":236,"pos":[-3840,-1408],"params":["Inherit","False","Property","_FrSolidColorActive","Fr Solid Color Active","19","0","Create","True","0","0","0","False","0","False","Object","-1","","0","0","0","1","0","1","FLOAT","0"]}
{"type":"AmplifyShaderEditor.ColorNode, AmplifyShaderEditor","id":85,"pos":[-3840,-1280],"params":["Inherit","False","Property","_FrSolidColor","Fr Solid Color","18","0","Create","True","0","0","0","False","3","Space(33)","Header(Fresnel)","Space(13)","False","Object","-1","","1,1,1,0","1,1,1,0","True","True","0","6","COLOR","0","FLOAT","1","FLOAT","2","FLOAT","3","FLOAT","4","FLOAT3","5"]}
...
{"type":"AmplifyShaderEditor.ColorNode, AmplifyShaderEditor","id":238,"pos":[-3840,-1920],"params":["Inherit","False","Property","_CenterColor","Center Color","13","0","Create","True","0","0","0","False","3","Space(33)","Header(Center Color)","Space(13)","False","Object","-1","","1,1,1,0","1,1,1,0","True","True","0","6","COLOR","0","FLOAT","1","FLOAT","2","FLOAT","3","FLOAT","4","FLOAT3","5"]}
...
{"type":"AmplifyShaderEditor.TemplateMultiPassMasterNode, AmplifyShaderEditor","id":253,"pos":[0,100],"params":["Float","False","False","-1","3","UnityEditor.ShaderGraphLitGUI","0","1","New Amplify Shader","94348b07e5e8bab40bd6c8a1e3df54cd","True","MotionVectors","0","10","MotionVectors","0","False","False","False","False","False","False","False","False","False","False","False","False","True","0","False","","False","True","0","False","","False","False","False","False","False","False","False","False","False","True","False","0","False","","255","False","","255","False","","0","False","","0","False","","0","False","","0","False","","0","False","","0","False","","0","False","","0","False","","False","True","1","False","","True","3","False","","True","True","0","False","","0","False","","False","True","4","RenderPipeline=UniversalPipeline","RenderType=Opaque=RenderType","Queue=Geometry=Queue=0","UniversalMaterialType=Lit","True","5","True","14","all","0","False","False","False","False","False","False","False","False","False","False","False","False","False","False","False","False","True","True","True","False","False","0","False","","False","False","False","False","False","False","False","False","False","False","False","False","False","True","1","LightMode=MotionVectors","False","False","0","","0","0","Standard","0","False","0"]}
{"type":"AmplifyShaderEditor.TemplateMultiPassMasterNode, AmplifyShaderEditor","id":254,"pos":[0,100],"params":["Float","False","False","-1","3","UnityEditor.ShaderGraphLitGUI","0","1","New Amplify Shader","94348b07e5e8bab40bd6c8a1e3df54cd","True","XRMotionVectors","0","11","XRMotionVectors","0","False","False","False","False","False","False","False","False","False","False","False","False","True","0","False","","False","True","0","False","","False","False","False","False","False","False","False","False","False","True","False","0","False","","255","False","","255","False","","0","False","","0","False","","0","False","","0","False","","0","False","","0","False","","0","False","","0","False","","False","True","1","False","","True","3","False","","True","True","0","False","","0","False","","False","True","4","RenderPipeline=UniversalPipeline","RenderType=Opaque=RenderType","Queue=Geometry=Queue=0","UniversalMaterialType=Lit","True","5","True","14","all","0","False","False","False","False","False","False","False","False","False","False","False","False","False","False","False","False","True","True","True","True","True","0","False","","False","False","False","False","False","False","False","True","True","1","False","","255","False","","1","False","","7","False","","3","False","","0","False","","0","False","","0","False","","0","False","","0","False","","0","False","","False","False","False","False","False","True","1","LightMode=XRMotionVectors","False","False","0","","0","0","Standard","0","False","0"]}
{"wire":[219,0,218,1]}
{"wire":[221,0,158,0]}
{"wire":[221,1,222,0]}
{"wire":[159,0,221,0]}
...
{"wire":[1,8,194,0]}
ASEEND*/
//CHKSM=8B47B159D0FD8592E37BF703F9AC909E97C0F2BB